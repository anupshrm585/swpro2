...
//var QueryString = 'lists.php?find='+membership_id;
 ...
 //var usname = 'test';
 //var passw = 'pass';
    var QueryString = 'ajax/ajaxlogin.php?username='+email;
 //alert(QueryString);
 ...
 // document.getElementById('fry').innerHTML = '';
     ...
     // document.getElementById('footerSlideContent').innerHTML = response;
      ...
      // document.getElementById('click').innerHTML ='<input type="submit" name="KT_Insert1" id="KT_Insert1" value="Register" />'
	   ...
	   if(response == 0)
	   {
	   document.getElementById('fry').innerHTML = '<img src="wrong.jpg" height="15" width="15"  />';
	   
	   }

      if(response == 1)
	   {
	   document.getElementById('fry').innerHTML = '<img src="right.jpg" height="20" width="20" />';
...
<b>i)</b>	The applicant must qualify for our overall assessment for further processing.<br>
  ...
  <tr>
    ...
    <td ><input name="memtype" value="Gold" type="radio" > Gold
    
    </td>
    </tr>
    <tr>
    
    <td ><input name="memtype" value="Silver" type="radio"> Silver
    
    </td>
    </tr>
    <tr>
    
    <td ><input name="memtype" value="Platinum" type="radio"> Platinum 
    </td>
    </tr>
<tr><td></td><td> <input type="submit" value="Submit" class="button success"/></td></tr>
